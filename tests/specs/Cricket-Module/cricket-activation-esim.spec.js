...
test.describe("Activation Test for Cricket - ESIM", () => {
    ...
    const zipcode = '33133', imei = '123456123456123'
    ...
    test('Test Case 60922: Should not be able to proceed without filling all the required fields,IMEI.', async ({ }) => {
        await page.locator(cricketActivation.esimToggle).click()
    ...
    test('Test Case 60890: Should be able to set the Device Information - ESIM', async ({ }) => {
    ...
    test('Test Case 60925: Should be able to select a plan from the options displayed.', async ({ }) => {
        ...
        await expect(page.locator(cricketActivation.esimIcon)).toBeVisible()
    ...
    test('Test Case 60934: Should be able to agree on terms and conditions and complete order.', async ({ }) => {
        ...
        await expect(page.locator(cricketActivation.esimIndicator).first()).toBeVisible()
        await expect(page.getByText('E-SIM')).toHaveText('E-SIM')
